...
namespace KLPlugins.DynLeaderboards.Settings.UI {
    ...
    public partial class ClassSettingsTab : UserControl {
        private ClassSettingsTabViewModel _viewModel { get; set; }
    ...
    internal class ClassSettingsTabViewModel : INotifyPropertyChanged {
        ...
        public ClassListBoxItem? SelectedClass {
            ...
            set {
                ...
                this.SelectedClassViewModel = value == null ? null : new SelectedClassViewModel(this._classesManager.Get(value.ViewModel.Class)!, this._classesManager, this._settingsControl, this.AllClassesView);
...
#pragma warning restore CS8618
        ...
        internal ClassSettingsTabViewModel(SettingsControl settingsControl, Values values, ClassInfos.Manager classesManager) : base() {
            this._values = values;
            ...
            this.ClassesListCollectionView = new ListCollectionView(this._classesListBoxItems) {
                IsLiveSorting = true,
                CustomSort = new ClassListBoxItemViewModel.KeyComparer()
            };

            foreach (var item in this._classesManager) {
                this._classesListBoxItems.Add(new ClassListBoxItem(new ClassListBoxItemViewModel(item.Value, this, this._classesManager)));
            }
            ...
            this._classesManager.CollectionChanged += (s, e) => {
                if (e.NewItems != null) {
                    ...
                    foreach (OverridableClassInfo.Manager item in e.NewItems) {
                        this._classesListBoxItems.Add(new ClassListBoxItem(new ClassListBoxItemViewModel(item, this, this._classesManager)));
                    }
                ...
                if (e.OldItems != null) {
                    foreach (OverridableClassInfo.Manager item in e.OldItems) {
                        this._classesListBoxItems.Remove(this._classesListBoxItems.FirstOrDefault(x => x.ViewModel.Class == item.Key));
                    }
                }
            };
            ...
            this.SelectedClass = (ClassListBoxItem?)this.ClassesListCollectionView.CurrentItem ?? this._classesListBoxItems.FirstOrDefault();
    ...
    internal class SelectedClassViewModel : INotifyPropertyChanged {
        ...
        internal SelectedClassViewModel(OverridableClassInfo.Manager manager, ClassInfos.Manager classesManager, SettingsControl settingsControl, ListCollectionView allClassesView) {
    ...
    internal class ClassListBoxItemViewModel : INotifyPropertyChanged {
        ...
        internal ClassListBoxItemViewModel(OverridableClassInfo.Manager manager, ClassSettingsTabViewModel vm, ClassInfos.Manager classesManager) {
            this._classManager = manager;
            this._classesManager = classesManager;
        ...
        internal void SetReplaceWith(OverridableClassInfo.Manager? replacement) {
            this.ReplaceWithPreview?.Unsubscribe(); // unsubscribe old preview from the manager so that the manager doesn't hold a reference to it and the preview could be destroyed
        ...
        internal class KeyComparer : IComparer {
            public int Compare(object x, object y) {
                ...
                if (x is ClassListBoxItem x2 && y is ClassListBoxItem y2) {
                    return string.Compare(x2.ViewModel._classManager.Key.AsString(), y2.ViewModel._classManager.Key.AsString(), StringComparison.OrdinalIgnoreCase);
                } else {
    ...
    internal class DesignClassSettingsTabViewModel : ClassSettingsTabViewModel {
        ...
        public new ListCollectionView ClassesListCollectionView { get; set; } = CreateClasses();
        public new ListCollectionView AllClassesView { get; set; } = new ListCollectionView(new string[] { "a", "b" });

        private static ListCollectionView CreateClasses() {
            List<ClassListBoxItem> list = [CreateSelectedItem()];
    ...
    internal class DesignSelectedClassViewModel : SelectedClassViewModel {
        public new CarClass Class { get; set; } = new CarClass("Test22");
        public new bool IsColorEnabled { get; set; } = true;
        ...
        public new CarClass ReplaceWith { get; set; } = new CarClass("Test2");
